...
export const asciidocHighlight = [
  ...
  EditorView.baseTheme({
    ...
    '.adoc-attribute, .adoc-attribute-ref': { color: '#6639ba' },
    '.adoc-include': { color: '#0550ae' },
    '.adoc-passthrough': { color: '#953800', backgroundColor: '#fff8f0' },
    '.adoc-document-header': { color: '#656d76' },
    '.adoc-thematic-break, .adoc-page-break': { color: '#656d76', fontWeight: 'bold' },
    ...
    '.adoc-checklist-marker, .adoc-dlist-marker': { color: '#953800', fontWeight: 'bold' },
    '.adoc-dlist-term': { color: '#0550ae', fontWeight: 'bold' },
    '.adoc-qanda-label': { color: '#8250df', fontWeight: 'bold' },
    '.adoc-block-title': { color: '#656d76', fontStyle: 'italic' },
    '.adoc-lead': { fontSize: '1.05em', color: '#24292f' },
    '.adoc-replacement, .adoc-escape': { color: '#6639ba' },
    '.adoc-callout': { color: '#bc4c00', fontWeight: 'bold' },
    '.adoc-strong': { fontWeight: 'bold' },
    '.adoc-emphasis': { fontStyle: 'italic' },
    '.adoc-monospace': { color: '#0a3069', backgroundColor: '#f6f8fa' },
    '.adoc-highlight': { backgroundColor: '#fff8c5' },
    '.adoc-superscript': { verticalAlign: 'super', fontSize: '0.85em' },
    '.adoc-subscript': { verticalAlign: 'sub', fontSize: '0.85em' },
    '.adoc-hardbreak': { color: '#656d76', fontWeight: 'bold' },
    '.adoc-link': { color: '#0969da', textDecoration: 'underline' },
    '.adoc-anchor, .adoc-xref': { color: '#8250df' },
    '.adoc-footnote': { color: '#953800', fontStyle: 'italic' },
    ...
    '.adoc-audio-marker, .adoc-video-marker': { color: '#8250df' },
    '.adoc-audio-target, .adoc-video-target': { color: '#0550ae' },
    '.adoc-audio-attrs, .adoc-video-attrs': { color: '#656d76' },
